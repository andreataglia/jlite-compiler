 ...
 *
 * This base class has no content other than its expType.
 *
 * @author Gerwin Klein
 * @version JFlex 1.6.1
 */
public class RegExp {
  ...
  /**
   * The expType of the regular expression. This field will be
  ...
  /**
   * Create a new regular expression of the specified expType.
   *
  ...
  public int size(Macros macros) {
    ...
    throw new Error("unknown regexp expType "+type);
  }
